...
- Can be added:
  ...
  - Examples showing use of some unused functions in examples: read(), attached(), detach(), writeMicroseconds(), etc. 
...
- Example can be added:
  ...
  - [ Project ] SimpleSnakeGame - Simple snake game on MKR RGB Shield and TFT LCD with input of buttons or gestures on Nano 33 BLE.
...
- Examples can be done:
  - [ Project ] SimpleSnakeGame - Simple snake game on TFT LCD Display with input of buttons or gestures on Nano 33 BLE / IOT
  - [ Project ] DisplayWeather - Display weather info on TFT LCD Display using TFT, JSON and WiFi libraries (To get clear understanding of how JSON are used in application)
...
| SnakeGame - Simple snake game on MKR RGB Shield with input of buttons or gestures | MKRRGB, TFT, Arduino_APDS9960| MKR RGB Shield / TFT LCD, Nano 33 BLE Sense |
...
Projects that will be done in this phase:
 ...
 1. SnakeGame - Simple snake game on MKR RGB Shield with input of buttons or gestures
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE0NDk5MDY4Ml19
-->